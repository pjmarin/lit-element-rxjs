...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/operators/pluck.js");
...
class AppComponent extends lit_element__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  static styles = lit_element__WEBPACK_IMPORTED_MODULE_0__.css`p { color: blue; }`;
  ...
  connectedCallback() {
    ...
    .pipe(
      (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.pluck)('name'),
...
class UserComponent extends lit_element__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    static styles = lit_element__WEBPACK_IMPORTED_MODULE_0__.css`p { color: blue; }`;
    static get properties() {
      return {
        name: { type: String }
...
const Store = function() {
  const subject = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject({ name: 'initial name' });
